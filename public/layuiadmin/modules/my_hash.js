...
layui.define(function (exports) {
    ...
    pearHash = {
        ...
        Base64: function () {
            ...
            this.decode = function (input) {
                ...
                let i, o1, o2, o3, h1, h2, h3, h4, bits, ac,
                    dec = '',
                    arr = [];
                if (!input) {
                    return input;
        ...
        MD5: function (options) {
             ...
             */
            let hexcase = (options && typeof options.uppercase === 'boolean') ? options.uppercase : false, // hexadecimal output case format. false - lowercase; true - uppercase
    ...
    // new MD5 instance
    let MD5 = new pearHash.MD5
    // new SHA1 instance
    let SHA1 = new pearHash.SHA1
    // new SHA256 instance
    let SHA256 = new pearHash.SHA256
    // new SHA512 instace
    let SHA512 = new pearHash.SHA512
    // new RIPEMD-160 instace
    let RMD160 = new pearHash.RMD160
    let Base64 = new pearHash.Base64
